...
class ProductTransactionExporter extends BaseStoreExporter
{
    ...
    public static function getColumns(): array
    {
        return [
            ...
            ExportColumn::make('meta.barcode')
                ->label('Barcode'),
            ExportColumn::make('meta.batch_number')
                ->label('Batch #'),
            ExportColumn::make('type'),
            ExportColumn::make('quantity'),
            ExportColumn::make('quantity_balance'),
